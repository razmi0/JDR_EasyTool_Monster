...
export const Fire = ({ size = "50px" }: IconProps) => {
  ...
  return (
    <div style={{ height: size.toString(), width: size.toString() }}>
      <svg viewBox="-33 0 255 255" preserveAspectRatio="xMidYMid" fill="#000000">
        <g strokeWidth="0"></g>
        <g strokeLinecap="round" strokeLinejoin="round"></g>
        <g>
          <defs>
            <style>
              {`.cls-3 { fill: ${cls.cls3}; } .cls-4 { fill: ${cls.cls4}; } .cls-5 { fill: ${cls.cls5}; }`}
            </style>
            <linearGradient
